...
from app.routes.api._admin.actions import router as _actions_router
...
from app.routes.api._admin.domains import router as _domains_router
from app.routes.api._admin.reports import router as _reports_router
from app.routes.api._admin.roles import router as _roles_router
from app.routes.api._admin.rules import router as _rules_router
from app.routes.api._admin.servers import router as _servers_router
