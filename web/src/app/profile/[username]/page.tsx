      ...
      <div className="profile-header">
        <div className="profile-info">
          ...
          <div className="profile-info-text" style={{ position: "relative" }}>
            ...
            <h2>{profile.display_name} {profile.is_locked && <Icon name="lock_filled" style={{ fontSize: "0.7em", verticalAlign: "middle", color: "var(--text-muted)" }} />} {(profile.role === "admin" || profile.role === "moderator") && (isMine || (profile as any).show_badge) && <Icon name="shield_filled" style={{ color: "#27ae60", fontSize: "0.75em", verticalAlign: "middle", marginLeft: 3 }} title={profile.role === "admin" ? "관리자" : "조율자"} />}{profile.role === "moderator" && <span className="role-badge role-mod">조율자</span>}</h2>
