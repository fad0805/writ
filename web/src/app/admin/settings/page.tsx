...
export default function AdminSettingsPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      else { const d = await res.json().catch(() => ({})) as { detail?: string | { msg?: string }[] }; setMsg(typeof d.detail === "string" ? d.detail : Array.isArray(d.detail) ? d.detail.map((e) => e.msg).join(", ") : "저장 실패"); }
    } catch { setMsg("오류 발생"); }
    setSaving(false);
  };
