...
def _avatar_html(user, size=40, cls=""):
    ...
    if img:
        return f'<img src="{img}" alt="" class="{cls}">'
    initial = (display_name or username)[0].upper()
    bg = f"hsl({hash(username) % 360}, 55%, 50%)"
    fs = size // 2
    r = size // 5
...
ICONS = {
    ...
    "mention": '<svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="4"/><path d="M16 8v5a3 3 0 0 0 6 0v-1a10 10 0 1 0-3.92 7.94"/></svg>',
    "direct": '<svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><path d="M22 6l-10 7L2 6"/></svg>',
